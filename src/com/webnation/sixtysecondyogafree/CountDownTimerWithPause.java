...
public abstract class CountDownTimerWithPause {
   ...
   */
    ...
    * Real time remaining until timer completes
    */
    private long mInitialTimeMillisInFuture;
   ...
   public void ResetClocktoMaxTime(long resetTime) { 
	   mPauseTimeRemaining = resetTime;
	   mMillisInFuture = resetTime;
   }
   ...
   public CountDownTimerWithPause(long millisOnTimer, long countDownInterval, boolean runAtStart) {
        ...
        mInitialTimeMillisInFuture = millisOnTimer;
